...
un cookie étant sauvegardé sur le poste de l'internaute, il peut potentiellement être volé ou détourné. On y met donc que des informations d'importance mineure : préférence, traces de visites... 
*/
...
//--------------------------
// Envoyer un cookie :
echo time();  // la fonction prédéfinie time() retourne le timesttamp de maintenant = nombre de secondes écoulées depuis le 01/01/1970 à 0h.
