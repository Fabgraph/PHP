...
var_dump($_SESSION);  // nous voyons encore le contenu de la session ici. En effet, il faut savoir que session_destroy() est d'abord lu par l'interpréteur, puis exécuter réellement qu'à la fin du script : pour le voir, vérifier le dossier xampp/tmp/ la session n'existe plus.

// Les sessions ont l'avantage d'être disponible partout sur le site, et donc dans tous les scripts (voir session2.php).