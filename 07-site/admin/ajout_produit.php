...
<!-- 3- formulaire d'ajout de profuit -->
...
<input type="hidden" id="id_produit" name="id_produit" value="0"><!-- ce champ caché est utile pour la modification d'un produit afin de l'identifier dans la requête SQL. La valeur 0 par défaut signifie que le produit n'existe pas en bdd, et qu'on est en trai de le créer -->
    ...
    <input type="file" name="photo" id="photo"><br><br><!-- le type file permet d'uploader un fichier et de remplir la superglobale $_FILES. Ne pas oublier l'attribut enctype dans la balise <form> de ce formulaire -->
