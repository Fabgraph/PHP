...
// debug($_SESSION);
extract($_SESSION['membre']); // extrait tous les indices de l'array sous forme de variables auxquelles on affecte la valeur dans l'array. Exemple: $_SESSION['membre']['pseudo'] devient $pseudo = $_SESSION['membre']['pseudo'];
