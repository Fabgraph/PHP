...
<form method="post" action="">
	...
	<input type="text" id="pseudo" name="pseudo" value="<?php echo (isset($_POST['pseudo'])) ? $_POST['pseudo'] : ''; ?>"><br><!-- l'opérateur "??" en PHP7 signifie "prend le premier qui existe". Ici on affiche donc $_POST['pseudo'] s'il existe, sinon un string vide  -->

	<label for="message">Message</label><br>	
	<textarea id="message" name="message"><?php echo (isset($_POST['message'])) ? $_POST['message'] : ''; ?></textarea><br>
