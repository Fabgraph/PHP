        ...
        <div class="collapse navbar-collapse" id="nav1">
        	<ul class="navbar-nav ml-auto">
                ...
                if (internauteEstConnecte()) {
                  echo '<li><a class="nav-link" href="'. RACINE_SITE .'ajout_salarie.php"></a>Se connecter</li>';
                ...
                if (internauteEstConnecteEtAdmin()) {
                  echo '<li><a class="nav-link" href="'. RACINE_SITE .'admin/ajout_salarie.php">Gestion des salariés</a></li>';
